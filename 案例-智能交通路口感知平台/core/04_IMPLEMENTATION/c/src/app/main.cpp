// @req DES-ARCH-004, SYS-REQ-001, SYS-REQ-002, SYS-REQ-005, SYS-REQ-006, SYS-REQ-007
// @design DES-ARCH-004-thread-model
// @test TC-CAM-001, TC-AI-DET-001, TC-FLOW-001, TC-CLOUD-001
// @author sw-team | @since 2026-06-04 | @version 1.0
// @status verified | @verified-at 2026-06-04
//
// Main entry for EdgeVision-T1 application.
// Implements 6-thread pipeline (4 capture + 1 infer + 1 reporter) per
// DES-ARCH-004 thread model. Supports both hardware (ZCU102) and
// --sim (no FPGA bitstream) modes.
