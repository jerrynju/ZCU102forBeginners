...
// @design DES-ARCH-008
// @test TC-AI-DET-001, TC-AI-LPR-001
// @author sw-team | @since 2026-06-04 | @version 1.0
// @status verified
//
// DPU inference engine: YOLOv8s INT8 vehicle/pedestrian detection +
// LPRNet INT8 plate recognition. Cascaded: detection → plate ROI → LPR.
